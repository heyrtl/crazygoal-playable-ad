...
export const UIOverlay = ({ gameState, onDownload }: UIOverlayProps) => {
  return (
    <div className="absolute inset-0 flex flex-col justify-center items-center overflow-hidden pointer-events-none" style={{ fontFamily: "'GameFont', sans-serif" }}>
      ...
      {/* End Card Overlay */}
      {gameState === 'EndCard' && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-xl flex flex-col landscape:flex-row items-center justify-evenly py-8 px-6 z-50 pointer-events-auto animate-[fadeIn_0.5s_ease-out]">
          
          <div className="flex flex-col items-center gap-4">
            {/* Victory Banner */}
            <div className="relative animate-[slideDown_0.8s_cubic-bezier(0.175,0.885,0.32,1.275)] pr-4">
              <svg width="280" height="140" viewBox="0 0 300 150" className="drop-shadow-[0_8px_0_rgba(0,0,0,0.8)]">
              ...
              <div className="absolute inset-0 flex items-center justify-center pb-6 pr-4">
                <h1 className="text-4xl text-[#1a1a2e] italic font-bold" 
                    style={{ 
            ...
            {/* Gift Box */}
            <div className="relative w-48 h-48 landscape:w-56 landscape:h-56 animate-[pulseScale_2s_infinite_ease-in-out]">
          ...
          {/* Download Button */}
          <div className="pointer-events-auto mt-4 landscape:mt-0">
            <button 
              onClick={onDownload}
            ...
            >
              ...
              <div className="relative bg-gradient-to-b from-[#a8ff78] to-[#2ecc71] border-4 border-black rounded-3xl px-12 py-5 transform transition-transform active:translate-y-2">
                <div className="absolute inset-0 bg-white/30 rounded-2xl h-1/3 mx-2 mt-1"></div>
                <span className="relative text-4xl text-white leading-tight block text-center font-bold" 
                      style={{ 
      ...
      {/* Instruction & Hand */}
      {gameState === 'Idle' && (
        <div className="absolute top-[22%] landscape:top-[18%] left-1/2 -translate-x-1/2 flex flex-col items-center pointer-events-none z-20">
          <div className="bg-black/75 backdrop-blur-md border border-white/20 rounded-xl px-4 py-2 flex items-center justify-center shadow-xl animate-[fadeIn_0.5s_ease-out] w-fit">
            <h2 className="text-[clamp(1.1rem,3.5vw,1.6rem)] text-white text-center leading-none uppercase font-bold tracking-tight whitespace-nowrap" 
                style={{ 
          ...
          <div className="mt-3 relative w-10 h-10">
            <img 
              src={HAND_DATA} 
              alt="Drag Hand" 
              className="w-10 h-10 animate-[dragDown_1.5s_infinite]"
